...
class Infos extends StatelessWidget {
  Infos({this.nom, this.add, this.dateNaissance, this.number, this.prenom, this.email,this.sex});
  String nom = "", prenom = "", add = "", dateNaissance = "", number = "",email="",sex="";
                ...
                child: Container(
                  child: Column(children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      onPressed: () async {
                        Response patient = await dio.post(
                            "https://dzcare.cleverapps.io/api/patients",
                            data: {
                              'first_name': '$prenom',
                              'last_name': '$nom',
                              'phone': '$number',
                        ...
                        if (allocation.statusCode != 200) {
                          besthospital = await dio
                              .get("https://dzcare.cleverapps.io/api/hospitals");
                          /* while(done==false){
